                                ...
                                <div class="mb-0 border-0 p-md-5 p-lg-0 p-4">
                                    <div class="mb-4 p-0">
                                        <a class='auth-logo' href='index.html'>
                                            <img src="{{asset('assets/images/logo-light.png')}}" alt="logo-dark" class="mx-auto" height="28" />
                                        </a>
                                    </div>

                                    <div class="pt-0">
                                        <form action="{{ route('login.save')}}" method="post" class="my-4">
                                            @csrf
                                            <div class="form-group mb-3">
                                                <label for="emailaddress" class="form-label">Username /  Email address</label>
                                                <input class="form-control" type="text" id="emailaddress" name="unique_id" required="" placeholder="Enter your email">
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <a href="{{ route('google.login')}}" class="btn text-dark border fw-normal d-flex align-items-center justify-content-center mb-3">
                    ...
                    <div class="col-xl-7">
                        <div class="account-page-bg p-md-5 p-4">
                            <div class="text-center">
                                <h3 class="text-dark mb-3 pera-title">Quick, Effective, and Productive With <span class="text text-primary"><a href="https://github.com/adarshsharma1350" target="_blank">Xeino</a></span> Admin Dashboard</h3>
...
<!-- Mirrored from zoyothemes.com/tapeli/html/auth-login by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Nov 2024 12:44:34 GMT -->
{{-- </html> --}}
