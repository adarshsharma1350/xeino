                ...
                <div class="row">
                    <div class="col-md-7 mx-auto">
                        <div class="mb-0 border-0 p-md-5 p-lg-0 p-4">
                            ...
                            <div class="pt-0">
                                <form action="{{route('register.save')}}" method="POST" class="my-4">
                                    @csrf
                                    ...
                                    <div class="form-group d-flex mb-3">
                                        <div class="col-12">
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label" for="checkbox-signin">I agree to the <a href="#" class="text-primary fw-medium"> Terms & Conditions</a></label>
                                            </div>
                                        </div><!--end col-->
                                    </div>
