...
<div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
    <div class="flex-grow-1">
        <h4 class="fs-28 fw-semibold m-0"><div>
            Welcome,
            <span class="font-bold font-weight-600 text-primary"> <a href="{{ route('user.profile', Auth::user()->username )}}">{{ ucfirst(preg_replace('/[^a-zA-Z].*/','',Auth::user()->username)) }}</span>
    </div></h4>
    </div>
</div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="fs-14 mb-1">Github Records</div>
                        </div>
