            ...
            <div class="container-xxl">
                <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
                    <div class="flex-grow-1">
                        <h4 class="fs-30 fw-semibold m-0">Profile</h4>
                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="align-items-center">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="overflow-hidden ms-4">
                                            <h4 class="m-0 text-dark fs-25"><span class="font-bold font-weight-600 text-primary"> {{ ucfirst(preg_replace('/[^a-zA-Z].*/','',Auth::user()->username)) }}</span></h4>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4 col-sm-4 col-lg-4">
                                                        <div class="profile-email">
                                                            ...
                                                            <a href="#"
                                                                class="text-primary fs-14 text-decoration-underline">{{ Auth::user()->email}}</a>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4 col-sm-4 col-lg-4">
                                                        <div class="profile-email">
                                    ...
                                    <div class="tab-pane pt-4" id="profile_experience" role="tabpanel">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 col-sm-12 col-lg-6">
                                                <h5 class="fs-16 text-dark fw-semibold mb-3 text-capitalize">Experience
                                                </h5>
                                            </div>
                                                        ...
                                                        <li class="profile-item">
                                                            ...
                                                            <div class="exper-item-list">
                                                                <div>
                                                                    ...
                                                                    <p class="mb-0">Responsible for the product
                                                                        management, product design, research and product
                                                                        partnerships teams at Notion.</p>
                                                                </div>
                                                            </div>
                                                        </li>
                                                    ...
                                                    <ol class="profile-section list-unstyled mb-0 px-4">
                                                        <li class="profile-item">
                                                            ...
                                                            <div class="exper-item-list">
                                                                ...
                                                                <p class="mb-0">Underlook 6 dynamic projects withing just
                                                                    8 months, showcasing my versatility and
                                                        ...
                                                        <li class="profile-item pb-0">
                                                            ...
                                                            <div class="exper-item-list">
                                                                ...
                                                                <p class="mb-0">Underlook 6 dynamic projects withing just
                                                                    1 months, showcasing my versatility and
                                                                    proactiveapprocach. Notable accomplishments include:-
                                                                    Designed.</p>
                                                            </div>
                                                        </li>
